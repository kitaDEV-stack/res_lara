<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.tables.update', $table->id) }}" class="w-[500px] m-auto my-10">
                @csrf
                @method('PATCH')
                <div class="mb-3">
                    <x-input-label for="name" :value="__('Name')" />
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" required
                        autofocus autocomplete="name" value="{{ $table->name }}" />
                ...
                <div class="mb-3">
                    ...
                    <x-text-input id="guest_number" rows="4"
                        ...
                        type="number" name="guest_number" required autofocus autocomplete="guest_number"
